...
prompt = ("Static locked-off tripod shot. The camera does not move at all: no push in, no zoom, no pan, no drift, no "
          ...
          "outside the window shimmers and breathes softly, the panel lights glow steadily and never blink, never move, never change; faint dust motes "
          "drift in the warm light; the planet's cloud haze creeps imperceptibly. Nothing else moves. Extremely slow continuous "
